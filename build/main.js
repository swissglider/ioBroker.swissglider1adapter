...
class Swissglider1adapter extends utils.Adapter {
    constructor(options = {}) {
        super(Object.assign(Object.assign({}, options), { name: 'swissglider1adapter' }));
...
if (module.parent) {
    ...
    module.exports = (options) => new Swissglider1adapter(options);
}
else {
    // otherwise start the instance directly
    (() => new Swissglider1adapter())();
}
